...
export type ListingCategory = "pets" | "football" | "world-assets" | "tickets" | "items";
...
export const LISTINGS: Listing[] = [
  { id: "L-001", name: "Infernox – Rồng lửa Thần thoại", image: "🐉", category: "pets", rarity: "mythic", seller: "DragonMaster_X", sellerAvatar: "DM", price: 980000, originalValue: 1200000, quantity: 1, description: "Rồng thần thoại từ lõi núi lửa cổ đại. Đây là cơ hội hiếm có.", listedAt: daysAgo(0.5), views: 4820, favorites: 312, status: "active", tags: ["Hot", "Giảm giá"] },
  { id: "L-002", name: "Mỏ Tinh Thể Vũ Trụ", image: "💎", category: "world-assets", rarity: "mythic", seller: "CosmicLord_7", sellerAvatar: "CL", price: 6800000, originalValue: 7500000, quantity: 1, description: "Mỏ tinh thể lớn nhất galaxy, thu nhập thụ động 62K CR/tuần.", listedAt: daysAgo(1), views: 3200, favorites: 228, status: "active", tags: ["Thu nhập thụ động", "Hiếm"] },
  { id: "L-003", name: "El Dios – Cầu thủ Thần thoại", image: "👑", category: "football", rarity: "mythic", seller: "FootballGod", sellerAvatar: "FG", price: 2100000, originalValue: 2500000, quantity: 1, description: "Rating 100 – cầu thủ tối thượng. God Touch ability.", listedAt: daysAgo(2), views: 5100, favorites: 445, status: "active", tags: ["Hot", "Rating MAX"] },
  { id: "L-004", name: "Kiếm Thần Thoại Vũ Trụ", image: "🗡️", category: "items", rarity: "mythic", seller: "SwordSage_Z", sellerAvatar: "SS", price: 2400000, originalValue: 2800000, quantity: 1, description: "+120% sát thương toàn cục. Được đúc từ lõi ngôi sao chết.", listedAt: daysAgo(0.3), views: 2800, favorites: 198, status: "active", tags: ["Mạnh nhất"] },
  { id: "L-005", name: "Cổng Chiều Thứ Chín", image: "🌀", category: "world-assets", rarity: "mythic", seller: "PortalKeeper", sellerAvatar: "PK", price: 5500000, originalValue: 6200000, quantity: 1, description: "Cổng kết nối chiều không gian thứ 9. Cực kỳ hiếm.", listedAt: daysAgo(3), views: 2100, favorites: 176, status: "active", tags: ["Độc nhất"] },
  { id: "L-006", name: "Aqua Belle – Tiên cá Huyền thoại", image: "🧜", category: "pets", rarity: "legendary", seller: "OceanQueen", sellerAvatar: "OQ", price: 580000, originalValue: 680000, quantity: 1, description: "Tiên cá huyền thoại kiểm soát đại dương. Cực đẹp.", listedAt: daysAgo(1.5), views: 1900, favorites: 156, status: "active", tags: ["Nữ giới", "Nước"] },
  { id: "L-007", name: "Kai Müller – CM Huyền thoại", image: "⚽", category: "football", rarity: "legendary", seller: "GermanGK", sellerAvatar: "GG", price: 820000, originalValue: 980000, quantity: 1, description: "Tiền vệ Vision Master rating 97. Chuyền bóng 99.", listedAt: daysAgo(2.5), views: 1650, favorites: 122, status: "active", tags: ["Vision", "CM"] },
  { id: "L-008", name: "Tháp Ngân Hà", image: "🏛️", category: "world-assets", rarity: "legendary", seller: "GalaxyBuilder", sellerAvatar: "GB", price: 2600000, originalValue: 2800000, quantity: 1, description: "Tòa tháp cao nhất World Creator Alpha. Thu nhập 24K/tuần.", listedAt: daysAgo(4), views: 1300, favorites: 98, status: "active", tags: ["Thu nhập"] },
  { id: "L-009", name: "Giáp Rồng Đen", image: "🛡️", category: "items", rarity: "legendary", seller: "BlackDragon_V", sellerAvatar: "BD", price: 720000, originalValue: 840000, quantity: 1, description: "+88% phòng thủ. Làm từ vảy rồng đen huyền bí.", listedAt: daysAgo(1.2), views: 1100, favorites: 87, status: "active", tags: ["Phòng thủ"] },
  { id: "L-010", name: "Vé Chung Kết Football Universe VIP", image: "⭐", category: "tickets", rarity: "mythic", seller: "VIPKing", sellerAvatar: "VK", price: 340000, originalValue: 380000, quantity: 1, description: "Hộp VIP Exclusive Zone EX-01. Còn 6 ngày đến sự kiện.", listedAt: daysAgo(0.8), views: 3400, favorites: 287, status: "active", tags: ["Sắp diễn ra", "VIP"] },
  { id: "L-011", name: "Sylphina – Nữ thần gió", image: "🌪️", category: "pets", rarity: "epic", seller: "WindRider", sellerAvatar: "WR", price: 230000, originalValue: 280000, quantity: 1, description: "Tốc độ 990 – nhanh nhất trong các epic pets.", listedAt: daysAgo(3.5), views: 880, favorites: 64, status: "active", tags: ["Tốc độ cao"] },
  { id: "L-012", name: "Tinh Thạch Huyền Bí x10", image: "💠", category: "items", rarity: "epic", seller: "CraftMaster", sellerAvatar: "CM", price: 270000, originalValue: 320000, quantity: 10, description: "Nguyên liệu chế tạo cấp S. Bộ 10 viên.", listedAt: daysAgo(2.2), views: 760, favorites: 55, status: "active", tags: ["Craft", "x10"] },
  { id: "L-013", name: "Son Heung-Min – RW Huyền thoại", image: "⚽", category: "football", rarity: "legendary", seller: "KoreanKing", sellerAvatar: "KK", price: 590000, originalValue: 660000, quantity: 1, description: "Counter Attack specialist. Pace 97, Shooting 91.", listedAt: daysAgo(5), views: 1420, favorites: 105, status: "active", tags: ["Counter Attack"] },
  { id: "L-014", name: "Sân Vận Động Vũ Trụ", image: "🏟️", category: "world-assets", rarity: "legendary", seller: "StadiumOwner", sellerAvatar: "SO", price: 1700000, originalValue: 1900000, quantity: 1, description: "Sức chứa 500K khán giả. Thu nhập 14K CR/tuần.", listedAt: daysAgo(6), views: 980, favorites: 82, status: "active", tags: ["Bóng đá", "Thu nhập"] },
  { id: "L-015", name: "Bản Đồ Kho Báu Huyền Thoại x2", image: "🗺️", category: "items", rarity: "legendary", seller: "TreasureHunter", sellerAvatar: "TH", price: 550000, originalValue: 650000, quantity: 2, description: "Mở khóa vùng đất ẩn bậc S trong World Creator.", listedAt: daysAgo(1.8), views: 640, favorites: 49, status: "active", tags: ["World Creator"] },
  { id: "L-016", name: "Giày Tốc Độ Sấm Sét", image: "👟", category: "items", rarity: "epic", seller: "SpeedDemon", sellerAvatar: "SD", price: 76000, originalValue: 88000, quantity: 1, description: "+52% tốc độ di chuyển. Nhanh như tia sét.", listedAt: daysAgo(4.5), views: 520, favorites: 41, status: "active", tags: ["Tốc độ"] },
  { id: "L-017", name: "Vé Giải Đấu Pet Huyền Thoại VIP", image: "🎖️", category: "tickets", rarity: "legendary", seller: "EventPro", sellerAvatar: "EP", price: 160000, originalValue: 185000, quantity: 1, description: "VIP Box A-01. Gặp nhà vô địch, Poster signed.", listedAt: daysAgo(2.8), views: 720, favorites: 58, status: "active", tags: ["Pet Battle", "VIP"] },
  { id: "L-018", name: "Đền Cổ Đại Luminos", image: "⛩️", category: "world-assets", rarity: "epic", seller: "AncientOne", sellerAvatar: "AO", price: 560000, originalValue: 620000, quantity: 1, description: "Đền thờ 1000 năm tuổi với phép thuật cổ đại.", listedAt: daysAgo(7), views: 430, favorites: 36, status: "active", tags: ["Monument"] },
  { id: "L-019", name: "Voltrix – Sói Sấm Huyền thoại", image: "🐺", category: "pets", rarity: "legendary", seller: "StormPack", sellerAvatar: "SP", price: 540000, originalValue: 620000, quantity: 1, description: "Lightning element. Attack 880, Speed 940.", listedAt: daysAgo(3.2), views: 890, favorites: 71, status: "active", tags: ["Lightning", "Tấn công"] },
  { id: "L-020", name: "Nhẫn Sức Mạnh Huyền Bí", image: "💍", category: "items", rarity: "epic", seller: "RingForge", sellerAvatar: "RF", price: 60000, originalValue: 72000, quantity: 1, description: "+44% sức tấn công. Nhẫn cổ đại tăng cường.", listedAt: daysAgo(5.5), views: 380, favorites: 29, status: "active", tags: ["Equipment"] },
  { id: "L-021", name: "Luminos Prime – Phượng hoàng", image: "🦅", category: "pets", rarity: "mythic", seller: "LightBearer", sellerAvatar: "LB", price: 890000, originalValue: 1050000, quantity: 1, description: "Ánh sáng vĩnh cửu, biểu tượng của sự hồi sinh.", listedAt: daysAgo(1.1), views: 3800, favorites: 290, status: "active", tags: ["Light", "Hot"] },
  { id: "L-022", name: "Vé Galaxy Music Festival Huyền thoại", image: "🎵", category: "tickets", rarity: "legendary", seller: "MusicLover", sellerAvatar: "ML", price: 142000, originalValue: 162000, quantity: 1, description: "Legendary Stage + Backstage pass + Gặp nghệ sĩ.", listedAt: daysAgo(3.8), views: 610, favorites: 47, status: "active", tags: ["Âm nhạc", "Backstage"] },
  { id: "L-023", name: "Hầm Ngục Rồng Cổ Đại", image: "🏚️", category: "world-assets", rarity: "legendary", seller: "DungeonLord", sellerAvatar: "DL", price: 1450000, originalValue: 1600000, quantity: 1, description: "Kho báu + rồng cổ đại. Thu nhập 12K CR/tuần.", listedAt: daysAgo(8), views: 780, favorites: 63, status: "active", tags: ["Dungeon", "Thu nhập"] },
  { id: "L-024", name: "Thuốc Tăng Sức Mạnh Cấp S x5", image: "⚗️", category: "items", rarity: "epic", seller: "AlchemistPro", sellerAvatar: "AP", price: 48000, originalValue: 58000, quantity: 5, description: "+60% sức mạnh trong 48h. Hiệu quả mạnh nhất.", listedAt: daysAgo(6.5), views: 290, favorites: 22, status: "active", tags: ["Consumable", "x5"] },
  { id: "L-025", name: "Frostmaw – Gấu Băng Huyền thoại", image: "🐻", category: "pets", rarity: "legendary", seller: "IceLord", sellerAvatar: "IL", price: 500000, originalValue: 580000, quantity: 1, description: "Defense 920 – tank tốt nhất hiện tại.", listedAt: daysAgo(4.2), views: 720, favorites: 58, status: "active", tags: ["Tank", "Ice"] },
  // Sold
  { id: "L-026", name: "Ronaldo Silva – ST Thần thoại", image: "⚽", category: "football", rarity: "mythic", seller: "BrazilStar", sellerAvatar: "BS", price: 2100000, originalValue: 2200000, quantity: 1, description: "Đã bán.", listedAt: daysAgo(10), views: 6200, favorites: 512, status: "sold", tags: [] },
  { id: "L-027", name: "Tháp Thiên Hà Nguyên Thủy", image: "🗼", category: "world-assets", rarity: "mythic", seller: "CosmicLord_7", sellerAvatar: "CL", price: 9200000, originalValue: 9800000, quantity: 1, description: "Đã bán.", listedAt: daysAgo(12), views: 8800, favorites: 720, status: "sold", tags: [] },
  { id: "L-028", name: "Giáp Vĩnh Cửu", image: "🛡️", category: "items", rarity: "mythic", seller: "GuardianX", sellerAvatar: "GX", price: 2200000, originalValue: 2400000, quantity: 1, description: "Đã bán.", listedAt: daysAgo(8), views: 3400, favorites: 280, status: "sold", tags: [] },
  { id: "L-029", name: "Cờ Hiệu Đội Tuyển VIP x3", image: "🚩", category: "items", rarity: "epic", seller: "FanZone", sellerAvatar: "FZ", price: 38000, originalValue: 48000, quantity: 3, description: "Đã hết hạn.", listedAt: daysAgo(15), views: 210, favorites: 14, status: "expired", tags: [] },
  { id: "L-030", name: "Đảo Rồng – World Creator", image: "🏝️", category: "world-assets", rarity: "legendary", seller: "IslandKing", sellerAvatar: "IK", price: 1280000, originalValue: 1380000, quantity: 1, description: "Đã bán.", listedAt: daysAgo(9), views: 2100, favorites: 178, status: "sold", tags: [] },
];
...
export const AUCTIONS: Auction[] = [
  {
    id: "A-001", name: "Shadowfang – Mèo Bóng Đêm Huyền thoại", image: "🐱", category: "pets", rarity: "legendary",
    seller: "ShadowMaster", sellerAvatar: "SM", startPrice: 400000, currentBid: 488000, buyNowPrice: 650000,
    minIncrement: 5000, endTime: hoursFromNow(2.5), watchers: 284, isHot: true,
  ...
  {
    id: "A-002", name: "Kiếm Ngân Hà – Legendary Weapon", image: "⚔️", category: "items", rarity: "legendary",
    seller: "GalaxySword", sellerAvatar: "GS", startPrice: 700000, currentBid: 824000, buyNowPrice: 1100000,
    minIncrement: 10000, endTime: hoursFromNow(6), watchers: 198, isHot: true,
  ...
  {
    id: "A-003", name: "Cổng Thiên Đình – Epic Portal", image: "🌈", category: "world-assets", rarity: "epic",
    seller: "HeavenGate", sellerAvatar: "HG", startPrice: 380000, currentBid: 421000, buyNowPrice: 620000,
    minIncrement: 5000, endTime: hoursFromNow(18), watchers: 142, isHot: false,
  ...
  {
    id: "A-004", name: "Vé Chung Kết Universe VIP Mythic", image: "🏆", category: "tickets", rarity: "mythic",
    seller: "EventMaster", sellerAvatar: "EM", startPrice: 350000, currentBid: 472000, buyNowPrice: null,
    minIncrement: 8000, endTime: hoursFromNow(1.2), watchers: 521, isHot: true,
  ...
  {
    id: "A-005", name: "Yuki Tanaka – LW Legendary Speed", image: "⚽", category: "football", rarity: "legendary",
    seller: "JapanFC", sellerAvatar: "JF", startPrice: 600000, currentBid: 695000, buyNowPrice: 950000,
    minIncrement: 10000, endTime: hoursFromNow(36), watchers: 167, isHot: false,
  ...
  {
    id: "A-006", name: "Tideborn – Epic Water Pet", image: "🐋", category: "pets", rarity: "epic",
    seller: "OceanDepth", sellerAvatar: "OD", startPrice: 160000, currentBid: 198000, buyNowPrice: 280000,
    minIncrement: 3000, endTime: hoursFromNow(12), watchers: 88, isHot: false,
  ...
  {
    id: "A-007", name: "Đảo Nổi Mây – Rare Land", image: "☁️", category: "world-assets", rarity: "rare",
    seller: "SkyIsland", sellerAvatar: "SI", startPrice: 90000, currentBid: 112000, buyNowPrice: 180000,
    minIncrement: 2000, endTime: hoursFromNow(48), watchers: 62, isHot: false,
  ...
  {
    id: "A-008", name: "Bộ Giáp Vĩnh Cửu – Fragment x3", image: "🛡️", category: "items", rarity: "epic",
    seller: "FragmentHunter", sellerAvatar: "FH", startPrice: 120000, currentBid: 155000, buyNowPrice: 220000,
    minIncrement: 5000, endTime: hoursFromNow(24), watchers: 94, isHot: false,
  ...
  {
    id: "A-009", name: "Pyrex – Cáo Lửa Rare", image: "🦊", category: "pets", rarity: "rare",
    seller: "FireFox_K", sellerAvatar: "FK", startPrice: 60000, currentBid: 78000, buyNowPrice: 110000,
    minIncrement: 2000, endTime: hoursFromNow(72), watchers: 41, isHot: false,
  ...
  {
    id: "A-010", name: "Luis Vargas – GK Legendary Iron Wall", image: "🧤", category: "football", rarity: "legendary",
    seller: "GoalieKing", sellerAvatar: "GK", startPrice: 550000, currentBid: 612000, buyNowPrice: 820000,
    minIncrement: 8000, endTime: hoursFromNow(3.8), watchers: 156, isHot: true,
